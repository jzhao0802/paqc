...
@pytest.mark.parametrize("df_new, expected, ls_faults", [
    # identical to suite2_df_old.csv
    (csv.read_csv(DICT_CONFIG_50, "paqc/tests/data/qc50_check1.csv")[1],
     True, None),
    ...
    (csv.read_csv(DICT_CONFIG_50, "paqc/tests/data/qc50_check2.csv")[1],
    ...
    (csv.read_csv(DICT_CONFIG_50, "paqc/tests/data/qc50_check3.csv")[1],
